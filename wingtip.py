...
"""Parametric ornithopter wingtip: edit CONFIG, run, look at out/*.png, read out/report.txt.
    ...
    .venv/bin/python wingtip.py --airfoil data/airfoils/my_s1223_mod.dat
...
# ----------------------------------------------------------------------------- #
CONFIG = {
    "airfoil": "s1223",          # UIUC name (auto-fetched to data/airfoils/) or path to your .dat
...
def parse_args(argv=None):
    ...
    ap.add_argument("--airfoil", help="path to a .dat file (Selig/Lednicer/SolidWorks) or UIUC name")
...
def main(argv=None) -> int:
    ...
    pngs = [render.plot_planform(cfg, b.holes, out / "planform.png"),
            render.plot_sections(cfg, b.foil, b.root3, b.tip3, b.holes, out / "section.png", cfg.wall_thickness_mm,
                                 tip_foil=b.tip_foil)]

    if not args.no_render:
        print("[4/5] rendering views ...")
        verts, tris = geo.tessellate(b.body)
        title = (f"root {cfg.root_chord_mm:g} / tip {cfg.tip_chord_mm:g} / span {cfg.span_mm:g} mm, sweep {cfg.le_sweep_deg:g}°, "
