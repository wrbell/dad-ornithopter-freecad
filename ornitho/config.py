...
class WingConfig:
    ...
    mount_holes: list = field(default_factory=lambda: [
        Hole("fwd", 18.0, 4.2), Hole("mid", 40.0, 4.2), Hole("aft", 65.0, 4.2)])
    ...
    def planform(self) -> Planform:
        return Planform(self.root_chord_mm, self.tip_chord_mm, self.span_mm,
                        self.le_sweep_deg, self.washout_deg, self.dihedral_deg)
